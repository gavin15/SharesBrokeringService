 ...
 * 
 */
@WebServiceClient(name = "UserWS", targetNamespace = "http://UserWS/", wsdlLocation = "http://localhost:13797/UserService1/UserWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWS_QNAME = new QName("http://UserWS/", "UserWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:13797/UserService1/UserWS?wsdl");
    ...
    public UserWS getUserWSPort() {
        return super.getPort(new QName("http://UserWS/", "UserWSPort"), UserWS.class);
    }
    ...
    public UserWS getUserWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://UserWS/", "UserWSPort"), UserWS.class, features);
    }
